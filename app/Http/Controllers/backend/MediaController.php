...
class MediaController extends Controller
{
    ...
    public function add_post(Request $req){
        ...
        switch ($data['media_type']) {
            case 'file':
                $data['media'] = $req->FilePath;
                break;
            case 'iframe':
                $data['media'] = $req->iframe;
                break;
            case 'link':
                $data['media'] = $req->link;
                break;
    ...
    public function edit_get($id,$lang = ''){
        ...
        $lang_id = DB::table('language')->where('nation',$this->__acc->nation)->select('id')->first()->id;
    ...
    public function list_get($key = ''){
        ...
        $data = DB::table($this->e['table'])->join($this->e['table'].'_common','fk_commonid','=',$this->e['table'].'_common.id')->where('nation',$this->__acc->nation)->where('type','media');
        ...
        $data = $data->select('image','name','authName','create_at','update_at','IsCustomer','status','order','language',$this->e['table'].'.id as id')->paginate(10);
        //return dd($data);
    ...
    public function delete($id,$lang = ''){
        ...
        if($this->__acc->role == 'content' && $common->authId != $this->__acc->id){
